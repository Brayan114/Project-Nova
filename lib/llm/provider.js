        ...
        const tools = [
            ...
            },
            {
                ...
                function: {
                    ...
                    description: "Execute a local shell command on the user's host machine (Windows). Use this to open apps (e.g. 'start code', 'start spotify'), launch tools, or run safe terminal commands.",
                    parameters: {
                        type: "object",
                        properties: {
                            command: {
